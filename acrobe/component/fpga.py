...
@JtagSramFpga.application_db.register("bnoc_continuous_transport")
async def _continuous(tap):
    from .nsl.jtag_continuous_transport import ContinuousTransport
    return ContinuousTransport(tap, tap.USER_IR[0])

@JtagSramFpga.application_db.register("bnoc_framed_transport")
