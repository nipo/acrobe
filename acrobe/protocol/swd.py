...
class Read:
    ...
    def __repr__(self):
        if self.ap:
            return f"Read(AP, {self.addr:#x})"
        return f"Read(DP, {self.addr:#x})"
...
class Write:
    ...
    def __repr__(self):
        if self.ap:
            return f"Write(AP, {self.addr:#x}, {self.data:#x})"
        return f"Write(DP, {self.addr:#x}, {self.data:#x})"
